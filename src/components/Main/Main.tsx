    ...
    <form className="form">
      <div className="fields">
        <div className="field__bill">
          <label className="field__label field__bill-label" htmlFor="billImput">bill</label>
          <input 
            type="number" 
            id="billImput" 
        ...
        <div className="field__tip-wrapper">
          <label className="field__label field__tip-label" htmlFor="tip">select tip %</label>
        ...
        <div className="field__people">
          <label className='field__label' htmlFor="people">Number of People</label>
          <input 
            type="number" 
            id="people" 
